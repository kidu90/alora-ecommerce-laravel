...
<body class="font-noto">
    ...
    <section class="bg-gray-100 py-8 sm:py-12 lg:py-20">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                <a href="{{ route('products') }}" class="block bg-white rounded-lg overflow-hidden shadow hover:shadow-lg transition">
    ...
    <section class="container mx-auto px-4 py-16">
        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-4 gap-8">
            @php
                $latestProducts = \App\Models\Product::with('category')->latest()->take(4)->get();
            @endphp
            ...
            @else
                <div class="col-span-full text-center py-8">
                    ...
                    <a href="{{ route('products') }}" class="text-blue-500 hover:underline">Browse all products</a>
                </div>
            @endif
        </div>
    </section>
